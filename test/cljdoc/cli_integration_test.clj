...
(t/deftest ingest-and-offline-docset-test
  ...
  (let [shell-opts {:extra-env {"CLJDOC_DATA_DIR" test-data-dir}}]
    ...
    (fs/delete-if-exists "target/bidi-docset.zip")
    (fs/create-dirs "target")
    (process/shell shell-opts "bb offline-docset --project bidi --version 2.1.3 --output target/bidi-docset.zip")
    (let [dest-dir "target/test/cli-integration"]
      (fs/delete-tree dest-dir)
      (fs/create-dirs dest-dir)
      (fs/unzip "target/bidi-docset.zip" dest-dir)
