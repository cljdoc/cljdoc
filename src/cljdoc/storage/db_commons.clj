(ns cljdoc.storage.db-commons
  "Generic implementation details for the storage layer as defined in [[cljdoc.storage]].
...
(defn docs-available? [db-spec sql-exists? group-id artifact-id version-name]
