...
(defn- parse-rendered-emojis
  "Each typically looks like: <p><code>emoji-tag</code>unicode</p>
   can also render as, ex: <p><code>o2</code><g-emoji class=\"g-emoji\" alias=\"o2\">🅾️</g-emoji></p>
...
(defn -main [& _args]
  (let [emojis (fetch-emojis)
        ...
        joined (reduce (fn [acc [k v]]
                       ...
                       emojis
                       rendered)
        emoji-edn-file "resources/emojis.edn"
        old-emojis (slurp emoji-edn-file)
        new-emojis (str ";; DO NOT EDIT: Generated by bb update-github-emojis\n\n"
                        (with-out-str (pprint/pprint joined)))]
    (if (not= old-emojis new-emojis)
      (do
