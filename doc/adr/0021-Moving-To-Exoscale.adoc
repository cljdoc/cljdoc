...
* [done] Add backup job to cljdoc
* Try/adapt deploy script
* Try/adapt full CI deploy
* Configure DNS at registrar (Martin)

In progress:
* traefik is 404ing all requests
** run consul as root (not transcribed to source yet)
** bind consul to 0.0.0.0 in consul config (not transcribed to source yet)
