...
- [done] Fire up a Compute instance manually at Exoscale, ssh in and poke around.
...
TODO: Because we want to be an ops team I'd like to somehow share terraform state.
...
A daily backup should be sufficient with backup strategy of:
* 7 daily
* 4 weekly
* 12 monthly
* 2 annually
