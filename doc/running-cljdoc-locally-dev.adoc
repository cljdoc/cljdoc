...
* https://adoptium.net/en-GB/temurin/releases/?version=21&package=jdk[Java Development Kit 21] - the cljdoc web server currently runs on JDK21 in production, so ideally, you'll want to be developing with JDK21 too.
