...
* https://adoptium.net/en-GB/temurin/releases/?version=26&package=jdk[Java Development Kit 26] - the cljdoc web server currently runs on JDK26 in production, so ideally, you'll want to be developing with JDK26 too.
